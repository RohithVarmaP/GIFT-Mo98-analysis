...
ylim <- abs(floor(log(min(GWAS_result$absolute_theta)))) +1
png("C:/Users/Rohith/Desktop/Gift_Project/Mo981.png", bg = "white", width = 9.75, height = 3.25, units = "in", res = 1200, pointsize = 4)
ggplot(GWAS_result, aes(x = bp_cum, y = (-log(absolute_theta)), # size = 1, 
...
saveWidget(html_file, "C:/Users/Rohith/Desktop/Gift_Project/Mo98_absolute_theta.html", selfcontained = T)
